...
import { listPublicSolutions } from "../../api/functions/solution.listPublicSolutions.api";
...
import { CarouselTrimController } from "@src/shared/ui/carousel/CarouselTrimController";
import SolutionStartHero from "../../components/SolutionStartHero";
import SolutionStartButton from "@src/marketing/components/startConfigurationButton/ConfigurationStartButton";
...
export default function CatalogSolution() {
  /* ===========================
     STATE
  =========================== */
  ...
  useEffect(() => {
    ...
    async function loadSolutions() {
      ...
      try {
        const data = await listPublicSolutions();
  ...
  /* ===========================
     ACTIONS
  =========================== */
  function handleSelectSolution(id: string| null) {
    setSelectedId(id);
    if(!id) return;
  ...
  onBusinessNameChange={setBusinessName} />
      ...
      {!loading && !error && solutions.length > 0 && (
        <>
          {/* ================= GRID ================= */}
          <CarouselTrimController
              selectedId={selectedId}
              className={cls.grid}
              onChange={handleSelectSolution} >
            ...
            <div style={{ height: "160px" }} />
            <SolutionStartButton
  disabled={!businessName.trim() || !selectedId}
