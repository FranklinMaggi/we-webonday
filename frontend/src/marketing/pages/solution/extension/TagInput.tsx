/**Estensione per pemrette a utente di inserire nuove description tag e business tag , da 
 * moderare , verificare , accettare , pubblicare , nella solution corrispondente 
 * progetto futuro 
  */
