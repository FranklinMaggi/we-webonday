...
import { listMyConfigurations } from "./base_configuration/configuration/api/configuration.list.user.api";
import type { ConfigurationUserSummaryDTO } from "./base_configuration/configuration/ConfigurationConfiguratorDTO";
...
import { getPreConfiguration } from "./base_configuration/configuration/api/getPreconfiguration";
